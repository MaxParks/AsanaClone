...
class User(db.Model, UserMixin):
    ...
    assigned_tasks = db.relationship('Task', foreign_keys=[add_prefix_for_prod('tasks.assigned_to')], back_populates='assignee')
    owned_tasks = db.relationship('Task', foreign_keys=[add_prefix_for_prod('tasks.owner_id')], back_populates='owner')
